#Edit the following lines to switch between atlas 1 and 2: 88, 93-94, 140, 421
...
#Edit the following lines to switch between no codes and no spuhs: 59 through 69, 413, 421

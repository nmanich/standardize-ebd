...
ebd <- read_ebd("ebd_US-WI_199501_200012_relMar-2023.txt", unique = FALSE, rollup = FALSE)
...
write.delim(ebdplussensitivepluszerocount, file = "WBBA1_ATLASWI_plussensitivepluszerocount_onlycodeds_nospuhslash_EBDMar2023_GOOD_082823.txt", sep="\t")

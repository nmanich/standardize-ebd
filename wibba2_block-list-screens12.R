...
# atlas data
bba2 <- read.delim(here("ebd_US-WI-007_201501_201912_relSep-2022.txt"), quote = "") 
...
fair <- read.csv("faircomparisonblocks1722.csv")
...
# breeding won't fall into column order and I'm not sure why
# relocate(uncoded_summary$prebreeding, .before = uncoded_summary$breeding)

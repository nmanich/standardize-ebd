...
ebd <- read_ebd("ebd_US-WI_norbob_relJul-2022.txt", unique = FALSE, rollup = FALSE)
...
write.delim(ebdplussensitivepluszerocount, file = "22EBDmergedwithSensitiveSpeciesandZeroCountRecords.txt", sep="\t")
